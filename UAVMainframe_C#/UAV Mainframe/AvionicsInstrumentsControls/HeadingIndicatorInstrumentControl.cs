...
namespace UAV_Mainframe
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(UAV_Mainframe.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(UAV_Mainframe.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(UAV_Mainframe.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Aircraft);        
